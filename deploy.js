...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-express-temp && mkdir riot-express-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir riot-express && cp -r riot-express-temp/* riot-express/ && rm -rf riot-express-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd riot-express && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `riot-express-temp` folder.');
